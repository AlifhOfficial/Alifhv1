...
export default function SignInSheetScreen() {
  ...
  const { signIn, openAuthFlow } = useAuth();
  ...
  async function handleSubmit() {
    ...
    try {
      const result = await AuthAPI.signInWithEmail(email.toLowerCase().trim(), password);
  ...
  async function handleForgotPassword() {
    ...
    if (!isValidEmail(normalizedEmail) || isLoading) {
    ...
    try {
      ...
      setResetNotice('Reset link sent. Check your email and come back to sign in.');
    } catch (err: any) {
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.sheet }]}> 
      ...
      <View style={styles.form}>
        ...
        {resetNotice ? (
          <Text variant="footnote" style={{ color: colors.success }} selectable>
            {resetNotice}
          </Text>
        ) : null}
