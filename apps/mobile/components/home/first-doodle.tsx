/**
 * First Doodle - Text-based decorative pattern for Revvup First grid
 * Creates a luxury monogram pattern using scattered "first" text
 * Elegant cursive typography at various angles and opacities
 */
...
// Scattered "first" text positions - like luxury brand monograms
...
interface FirstDoodleProps {
  opacity?: number;
  color?: string;
}

export const FirstDoodle = memo(function FirstDoodle({ 
  opacity = 1,
  color = '#0D0D0D',
}: FirstDoodleProps) {
  return (
