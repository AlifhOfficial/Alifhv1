          ...
          <div className="flex items-center gap-1.5">
            {controller.isOtherOnline && (
              <div className="flex items-center gap-1">
                ...
                <span className="text-[10px] sm:text-caption1 font-semibold text-green-600 dark:text-green-400">Active</span>
              </div>
            )}
            {!controller.isOtherOnline && lastActiveAt && (
              <span className="text-[10px] sm:text-caption1 font-medium text-muted-foreground/70">Last seen {getLastSeenText(lastActiveAt)}</span>
            )}
            {!controller.isOtherOnline && !lastActiveAt && (
              <span className="text-[10px] sm:text-caption1 font-medium text-muted-foreground/50">Away</span>
            )}
          </div>
        </div>
