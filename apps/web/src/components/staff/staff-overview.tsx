    ...
    return (
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center py-24">
          ...
          <h3 className="text-lg font-medium mb-2">No Staff Profile Found</h3>
    ...
    <div className="max-w-4xl mx-auto px-6 py-16 space-y-16">
      ...
      <section className="space-y-8">
        <div className="border-b border-border/40 pb-2">
          <h3 className="text-lg font-medium tracking-tight">Your Dealership</h3>
        </div>
        ...
        <div className="rounded-xl border border-border p-8 space-y-6">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <h2 className="text-xl font-semibold mb-1">{staffProfile.partner.brandName}</h2>
              <p className="text-sm text-muted-foreground mb-3">{staffProfile.partner.companyNameLegal}</p>
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-md bg-green-500/10 text-sm text-green-500">
      ...
      <section className="space-y-8">
        ...
        {hasWorkProfile ? (
          ...
          <div className="text-center py-16 rounded-xl border border-border">
            ...
            <Link 
              href="/staff-dashboard/profile"
              className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-blue-500 hover:bg-blue-600 text-white text-sm transition-colors"
            >
              Set Up Profile
      ...
      <section className="space-y-8">
        <div className="border-b border-border/40 pb-2">
          <h3 className="text-lg font-medium tracking-tight">Quick Access</h3>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          >
            ...
            <p className="text-sm text-muted-foreground">View your workplace information</p>
          </Link>
          ...
          >
            ...
            <p className="text-sm text-muted-foreground">Manage your work identity</p>
          </Link>
        </div>
      </section>
    </div>
