  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="max-w-7xl mx-auto px-4 compact:px-6 large:px-8 py-6 compact:py-8 large:py-12">
        {/* Header */}
        <header className="flex items-center justify-between mb-4 compact:mb-6 pb-4 compact:pb-6 border-b border-border">
        ...
        {/* Footer */}
        {showFooter && footer && (
          <div className="mt-6 compact:mt-8 pt-4 compact:pt-6 border-t border-border">{footer}</div>
        )}
      </div>
    </div>
  );
