    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-wrap gap-3">
        ...
        {isSuspended ? (
          <button
            ...
            className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-success hover:bg-success/90 text-white text-subhead transition-colors disabled:opacity-50"
          >
          ...
          <button
            ...
            disabled={loading || isCancelled}
            className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-warning hover:bg-yellow-600 text-white text-subhead transition-colors disabled:opacity-50"
          >
        ...
        {isVerified ? (
          <button
            ...
            disabled={loading}
            className="inline-flex items-center gap-2 px-5 py-2 rounded-full border border-border hover:bg-secondary/10 text-subhead transition-colors disabled:opacity-50"
          >
          ...
          <button
            ...
            disabled={loading}
            className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-primary hover:bg-primary/90 text-white text-subhead transition-colors disabled:opacity-50"
          >
            <Shield className="w-4 h-4" />
            Verify Partner
          </button>
        ...
        {!isCancelled && (
          <button
            ...
            disabled={loading}
            className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-destructive hover:bg-destructive/90 text-white text-subhead transition-colors disabled:opacity-50"
          >
      ...
      <div className="grid grid-cols-2 regular:grid-cols-3 gap-3">
        ...
        <button
          ...
          disabled={loading}
          className="px-4 py-2.5 rounded-xl border border-border hover:bg-secondary/10 text-subhead transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
        >
        ...
        <button
          ...
          disabled={loading}
          className="px-4 py-2.5 rounded-xl border border-destructive/50 text-subhead text-destructive hover:bg-destructive-muted transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
        >
          ...
          <div className="bg-card rounded-xl border border-border max-w-md w-full">
            ...
            <div className="flex gap-3 px-6 py-4 border-t border-border">
              <button
                ...
                className="flex-1 px-5 py-2 rounded-full border border-border hover:bg-secondary/10 text-subhead transition-colors"
              >
                Cancel
              </button>
              <button
