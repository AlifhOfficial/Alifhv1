      ...
      <div className="bg-black px-2 sm:px-4 py-2 sm:py-3 flex items-center gap-1.5 sm:gap-3 min-w-0">
        ...
        <div className="flex items-center flex-shrink-0">
          <button
            ...
            className="flex items-center justify-center p-1 sm:p-1.5 rounded-full bg-transparent backdrop-blur-xl border border-white/[0.08] shadow-[inset_0_0.5px_0_0_rgba(255,255,255,0.05)] hover:bg-white/[0.1] hover:scale-105 active:scale-95 transition-all duration-200 cursor-pointer"
          >
            <svg className="w-3.5 sm:w-4 h-3.5 sm:h-4" viewBox="0 0 400 400" fill="none">
              <path
