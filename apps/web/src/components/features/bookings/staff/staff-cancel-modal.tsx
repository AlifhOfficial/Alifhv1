    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className={cn(
        ...
        <div className="p-6 text-center">
          ...
          <h2 className="text-headline font-semibold text-foreground mb-1.5">Cancel Booking</h2>
          ...
          <div className="space-y-2">
            <button
              onClick={onSubmit}
              disabled={isSubmitting}
              className="w-full h-11 bg-destructive text-destructive-foreground rounded-lg text-subhead font-semibold hover:bg-destructive/90 transition-colors disabled:opacity-50 inline-flex items-center justify-center gap-2"
            >
              {isSubmitting ? (
                <>
