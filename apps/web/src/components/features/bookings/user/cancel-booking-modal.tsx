      ...
      <div className="bg-card border border-border rounded-2xl p-6 sm:p-8 w-full max-w-md mx-4 shadow-2xl">
        ...
        <div className="flex gap-3">
          ...
          <button
            onClick={onSubmit}
            disabled={isSubmitting}
            className="flex-1 px-5 py-3 bg-destructive text-destructive-foreground rounded-full text-[15px] font-semibold tracking-tight hover:bg-destructive/90 transition-colors disabled:opacity-50 inline-flex items-center justify-center gap-2"
          >
            {isSubmitting ? (
              <>
