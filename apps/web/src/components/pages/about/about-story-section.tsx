      ...
      <div className="max-w-[1600px] mx-auto">
        ...
        <div className="grid compact:grid-cols-2 large:grid-cols-4 gap-4 max-w-5xl mx-auto">
          <div className="p-6 rounded-xl border border-border/40 bg-sidebar">
            ...
            <p className="text-subhead text-muted-foreground leading-relaxed">List your car for free. Always.</p>
          </div>
          <div className="p-6 rounded-xl border border-border/40 bg-sidebar">
            <Eye className="w-5 h-5 text-primary/80 mb-3" />
            <h3 className="text-callout font-semibold mb-1.5">No pay-to-rank</h3>
            <p className="text-subhead text-muted-foreground leading-relaxed">Fair visibility for everyone.</p>
          </div>
          <div className="p-6 rounded-xl border border-border/40 bg-sidebar">
            <Users className="w-5 h-5 text-primary/80 mb-3" />
            <h3 className="text-callout font-semibold mb-1.5">We don't compete</h3>
            <p className="text-subhead text-muted-foreground leading-relaxed">We connect. We don't sell cars.</p>
          </div>
          <div className="p-6 rounded-xl bg-primary text-primary-foreground">
            <Shield className="w-5 h-5 text-primary-foreground/70 mb-3" />
            <h3 className="text-callout font-semibold mb-1.5">On your side</h3>
            <p className="text-subhead text-primary-foreground/70 leading-relaxed">Your success is our success.</p>
          </div>
        </div>
