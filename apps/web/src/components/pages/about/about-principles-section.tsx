      ...
      <div className="max-w-[1600px] mx-auto">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 max-w-5xl mx-auto">
          <div className="p-6 rounded-xl bg-primary text-primary-foreground">
            ...
            <p className="text-subhead text-primary-foreground/70 leading-relaxed">Every decision starts with you.</p>
          </div>
          <div className="p-6 rounded-xl border border-border/40 bg-sidebar">
            <BanIcon className="w-5 h-5 text-primary/80 mb-3" />
            <h3 className="text-callout font-semibold mb-1.5">No ads, ever</h3>
            <p className="text-subhead text-muted-foreground leading-relaxed">Your attention isn't for sale.</p>
          </div>
          <div className="p-6 rounded-xl border border-border/40 bg-sidebar">
            <CheckCircle2 className="w-5 h-5 text-primary/80 mb-3" />
            <h3 className="text-callout font-semibold mb-1.5">Quality over quantity</h3>
            <p className="text-subhead text-muted-foreground leading-relaxed">Real listings only. No spam.</p>
          </div>
          <div className="p-6 rounded-xl border border-border/40 bg-sidebar">
            <Clock className="w-5 h-5 text-primary/80 mb-3" />
            <h3 className="text-callout font-semibold mb-1.5">Long-term thinking</h3>
            <p className="text-subhead text-muted-foreground leading-relaxed">Trust takes time to build.</p>
          </div>
        </div>
