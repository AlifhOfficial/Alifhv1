      ...
      <div className="max-w-[1600px] mx-auto">
        ...
        <div className="text-center mb-16 space-y-5">
          ...
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-semibold tracking-tight">
            See the pricing.
            <br />
            <span className="text-muted-foreground">Apply when you're ready.</span>
          </h2>
        </div>
        ...
        <p className="text-base text-muted-foreground max-w-lg mx-auto text-center mb-12 leading-relaxed">
          No commitment. No pressure. Just opportunity.
        </p>
  ...
  return (
    <div className="relative w-full rounded-lg overflow-hidden bg-sidebar border border-border/40 p-3 sm:p-6 lg:p-12">
      ...
      <div className="rounded-lg overflow-hidden shadow-2xl border border-white/10">
        ...
        {/* Window Content */}
        <div className="bg-[#000] flex items-center justify-center min-h-[480px] sm:min-h-[560px] lg:min-h-[680px] p-6 sm:p-10 lg:p-16">
