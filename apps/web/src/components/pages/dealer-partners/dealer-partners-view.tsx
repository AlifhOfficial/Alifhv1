      ...
      <section className="pt-28 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="rounded-xl border border-border/40 bg-sidebar p-8 text-center mb-6">
            ...
            <p className="text-3xl font-bold text-foreground tracking-tight mb-4">
              LOYALTY
            </p>
          ...
          <section className="mb-10">
            ...
            <div className="rounded-xl border border-border/40 bg-sidebar p-5 space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-sm font-semibold text-foreground mb-1">We only win when you make a sale</p>
                  <p className="text-sm text-muted-foreground leading-relaxed">
              ...
              <div className="flex items-start gap-3 pt-3 border-t border-border/20">
                ...
                <div>
                  <p className="text-sm font-semibold text-foreground mb-1">We're not your competitor</p>
                  <p className="text-sm text-muted-foreground leading-relaxed">
              ...
              <div className="flex items-start gap-3 pt-3 border-t border-border/20">
                ...
                <div>
                  <p className="text-sm font-semibold text-foreground mb-1">Your channel, not another platform</p>
                  <p className="text-sm text-muted-foreground leading-relaxed">
            ...
            <div className="rounded-xl border border-border/40 bg-sidebar p-5 space-y-4">
              ...
              <div className="grid gap-3 pt-2">
                <div className="flex items-center gap-3">
                  ...
                  <p className="text-sm text-muted-foreground"><span className="font-medium text-foreground">Short-term:</span> Quiet start</p>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-2 h-2 rounded-full bg-muted-foreground/50 flex-shrink-0" />
                  <p className="text-sm text-muted-foreground"><span className="font-medium text-foreground">Medium-term:</span> Momentum builds</p>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-2 h-2 rounded-full bg-primary flex-shrink-0" />
                  <p className="text-sm text-muted-foreground"><span className="font-medium text-foreground">Long-term:</span> You win</p>
                </div>
              </div>
            </div>
            
            <div className="mt-4 rounded-xl border border-primary/40 bg-sidebar p-5">
              <p className="text-sm font-semibold text-foreground mb-2">Why now is the perfect time</p>
              <div className="space-y-2">
                <div className="flex items-start gap-2">
                  <CheckCircle2 className="w-4 h-4 text-primary flex-shrink-0 mt-0.5" />
                  <p className="text-sm text-muted-foreground"><span className="font-medium text-foreground">Less competition</span> — your listings get more visibility</p>
                </div>
                <div className="flex items-start gap-2">
                  <CheckCircle2 className="w-4 h-4 text-primary flex-shrink-0 mt-0.5" />
                ...
                <div className="flex items-start gap-2">
                  <CheckCircle2 className="w-4 h-4 text-primary flex-shrink-0 mt-0.5" />
                  <p className="text-sm text-muted-foreground"><span className="font-medium text-foreground">Direct line to our team</span> — shape the platform</p>
                </div>
                <div className="flex items-start gap-2">
                  <CheckCircle2 className="w-4 h-4 text-primary flex-shrink-0 mt-0.5" />
                  <p className="text-sm text-muted-foreground"><span className="font-medium text-foreground">First-mover advantage</span> — dominate when we scale</p>
                </div>
              </div>
            </div>
          </section>
          ...
          <section className="mb-10">
            ...
            <div className="rounded-xl border border-border/40 bg-sidebar p-5">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <div className="p-4 rounded-lg bg-background/50 border border-border/20">
                  <p className="text-xs uppercase tracking-widest text-muted-foreground/70 mb-3">You Focus On</p>
                  <div className="space-y-2">
                ...
                <div className="p-4 rounded-lg bg-sidebar border border-primary/40">
                  <p className="text-xs uppercase tracking-widest text-primary/70 mb-3">We Handle</p>
                  <div className="space-y-2">
                    <div className="flex items-center gap-2 text-sm text-foreground">
            ...
            <div className="rounded-xl border border-border/40 bg-sidebar p-5 space-y-3">
              ...
              <div className="grid gap-2 pt-2">
                <div className="flex items-center gap-2">
                  ...
                  <p className="text-sm text-foreground">Better organized than legacy platforms</p>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-primary flex-shrink-0" />
                  <p className="text-sm text-foreground">Better executed than traditional marketplaces</p>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-primary flex-shrink-0" />
                ...
                <div className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-primary flex-shrink-0" />
                  <p className="text-sm text-foreground">Quality-based ranking (no paid boosts)</p>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-primary flex-shrink-0" />
                  <p className="text-sm text-foreground">Online test drive booking</p>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-primary flex-shrink-0" />
                  <p className="text-sm text-foreground">Blazing fast, no ads anywhere</p>
                </div>
              </div>
            ...
            <div className="rounded-xl border border-border/40 bg-sidebar p-5">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    <p className="text-xs text-muted-foreground/60 mb-1">What we're NOT</p>
                    <p className="text-sm text-muted-foreground leading-relaxed">The biggest yet. The flashiest. Perfect.</p>
                  </div>
                </div>
                <div className="flex items-start gap-2">
                  <CheckCircle2 className="w-3 h-3 text-primary flex-shrink-0 mt-1" />
                  <div>
                    <p className="text-xs text-primary/70 mb-1">What we ARE</p>
                    <p className="text-sm text-foreground font-semibold leading-relaxed">Focused. Committed. Honest. Building for you.</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <section className="mt-12">
            <div className="rounded-xl border border-primary/40 bg-sidebar p-8">
              ...
              <div className="grid sm:grid-cols-2 gap-4 mb-6">
                <div className="p-4 rounded-lg bg-background/50 border border-border/20">
                  <p className="text-xs uppercase tracking-widest text-muted-foreground/70 mb-2">What You Get</p>
                ...
                <div className="p-4 rounded-lg bg-background/50 border border-border/20">
                  <p className="text-xs uppercase tracking-widest text-muted-foreground/70 mb-2">What We Ask</p>
                  <div className="space-y-1.5">
                    <div className="flex items-center gap-2 text-sm text-foreground">
    ...
    <div className="rounded-xl border border-border/40 bg-sidebar p-5">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="flex items-start gap-2">
          <Circle className="w-3 h-3 text-muted-foreground/40 flex-shrink-0 mt-1" />
          <div>
            <p className="text-xs text-muted-foreground/60 mb-1">Others</p>
        ...
        <div className="flex items-start gap-2">
          <CheckCircle2 className="w-3 h-3 text-primary flex-shrink-0 mt-1" />
          <div>
            <p className="text-xs text-primary/70 mb-1">Revvup</p>
            <p className="text-sm text-foreground font-semibold leading-relaxed">{revvup}</p>
          </div>
        </div>
      </div>
    </div>
...
function PartnershipScenario({ scenario, others, revvup }: { scenario: string; others: string; revvup: string }) {
  return (
    <div className="rounded-xl border border-border/40 bg-background/50 p-4">
      <p className="text-sm font-semibold text-foreground mb-3">{scenario}</p>
      <div className="grid grid-cols-2 gap-4">
        <div className="flex items-start gap-2">
          <Circle className="w-3 h-3 text-muted-foreground/40 flex-shrink-0 mt-1" />
          <div>
            <p className="text-xs text-muted-foreground/60 mb-1">Others</p>
            <p className="text-sm text-muted-foreground leading-relaxed">{others}</p>
          </div>
        </div>
        <div className="flex items-start gap-2">
          <CheckCircle2 className="w-3 h-3 text-primary flex-shrink-0 mt-1" />
