    ...
    <>
      ...
      <MacOSWindow url="car-marketplace.ae" contentClassName="flex flex-col md:flex-row aspect-[3/4] sm:aspect-[4/3] md:aspect-[16/9] lg:aspect-[2.4/1] overflow-visible">
        ...
        <div className="flex-1 p-4 sm:p-8 lg:p-16 flex flex-col items-center justify-center border-b md:border-b-0 md:border-r border-white/5 min-h-[200px] sm:min-h-0 overflow-visible">
          <span className="text-[10px] sm:text-xs font-medium text-white/30 mb-4 sm:mb-8 lg:mb-10">Others</span>
          ...
          <div className="relative flex items-center justify-center gap-1 sm:gap-2 lg:gap-4 w-full max-w-full py-4 px-6 sm:px-4">
            ...
            {/* Fee badges */}
            <div className="absolute -top-2 sm:-top-3 lg:-top-4 right-4 sm:right-2 lg:-right-2 px-1.5 sm:px-3 lg:px-4 py-0.5 sm:py-1 lg:py-2 rounded-md bg-red-500 text-[7px] sm:text-[10px] lg:text-xs font-bold text-white shadow-xl rotate-3 z-20">
              AED 999
            ...
            <div className="absolute top-8 sm:top-12 lg:top-16 left-4 sm:left-2 lg:-left-2 px-1 sm:px-2 lg:px-3 py-0.5 sm:py-1 lg:py-1.5 rounded-md bg-orange-500 text-[6px] sm:text-[9px] lg:text-[11px] font-semibold text-white shadow-lg -rotate-6">
              Boost +49
            </div>
            <div className="absolute bottom-0 sm:-bottom-1 lg:-bottom-2 right-8 sm:right-12 lg:right-16 px-1 sm:px-2 lg:px-3 py-0.5 sm:py-1 lg:py-1.5 rounded-md bg-amber-600 text-[6px] sm:text-[9px] lg:text-[11px] font-semibold text-white shadow-lg rotate-2">
              Feature
            </div>
          </div>
          
          <p className="text-[9px] sm:text-[10px] lg:text-xs text-white/30 mt-4 sm:mt-6 lg:mt-10">Pay for everything</p>
        </div>
        ...
        <div className="w-full md:w-[200px] lg:w-[280px] xl:w-[360px] p-6 sm:p-10 lg:p-16 flex flex-col items-center justify-center min-h-[180px] sm:min-h-0">
          <span className="text-[10px] sm:text-xs font-medium text-primary mb-4 sm:mb-6 lg:mb-10">Revvup</span>
          
          <div className="flex flex-col items-center">
            {/* Giant zero */}
            <div 
              className="text-5xl sm:text-7xl lg:text-8xl xl:text-9xl font-bold text-primary leading-none"
              style={{ animation: 'glow-zero 3s ease-in-out infinite' }}
            >
              0
            </div>
            <span className="text-xs sm:text-sm lg:text-base text-primary/80 font-medium mt-1 sm:mt-2">fees</span>
          </div>
          
          <p className="text-[9px] sm:text-[10px] lg:text-xs text-white/30 mt-4 sm:mt-6 lg:mt-10">Just list</p>
        </div>
      </MacOSWindow>
    </>
  );
