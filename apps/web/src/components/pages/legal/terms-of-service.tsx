      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="mb-10 py-5 border-y border-border/40">
          ...
          <div className="flex flex-wrap items-center gap-2 mt-4">
            ...
            <Link href="/refund-policy" className="text-xs text-primary hover:underline font-medium">Refunds</Link>
            <span className="text-muted-foreground/40">·</span>
        ...
        <div className="space-y-10">
            ...
            <div className="rounded-xl border border-border/40 bg-sidebar p-5">
              ...
              <div className="space-y-4">
                <div className="py-3 border-b border-border/20">
                  <p className="text-sm font-semibold text-foreground mb-2">Billing</p>
                  <p className="text-sm text-muted-foreground leading-relaxed">
                ...
                <div className="py-3 border-b border-border/20">
                  <p className="text-sm font-semibold text-foreground mb-2">Setup Fee</p>
                  <p className="text-sm text-muted-foreground leading-relaxed">
          ...
          <section id="contact" className="scroll-mt-28">
            ...
            <div className="rounded-xl border border-border/40 bg-sidebar p-5">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <p className="text-sm font-semibold text-muted-foreground/70">Legal Entity</p>
                  <p className="text-sm font-medium text-foreground mt-0.5">AISH CAPITALS FZCO</p>
                </div>
                <div>
                  <p className="text-sm font-semibold text-muted-foreground/70">Country</p>
                  <p className="text-sm font-medium text-foreground mt-0.5">United Arab Emirates</p>
                </div>
