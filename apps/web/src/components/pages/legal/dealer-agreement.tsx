          ...
          <div className="space-y-16">
            ...
            <section id="access">
              ...
              <div className="space-y-4 mt-6">
                ...
                <ul className="space-y-2 pl-6">
                  <li className="text-base text-muted-foreground leading-relaxed list-disc">Non-exclusive</li>
                  <li className="text-base text-muted-foreground leading-relaxed list-disc">Non-transferable</li>
                  <li className="text-base text-muted-foreground leading-relaxed list-disc">Revocable</li>
                </ul>
                <p className="text-base text-muted-foreground leading-relaxed">
            ...
            <section id="indemnification">
              ...
              <div className="space-y-4 mt-6">
                ...
                <ul className="space-y-2 pl-6">
                  <li className="text-base text-muted-foreground leading-relaxed list-disc">ALIFH</li>
                  <li className="text-base text-muted-foreground leading-relaxed list-disc">AISH CAPITALS FZCO</li>
                  <li className="text-base text-muted-foreground leading-relaxed list-disc">
                ...
                <ul className="space-y-2 pl-6">
                  <li className="text-base text-muted-foreground leading-relaxed list-disc">Dealer listings</li>
                  <li className="text-base text-muted-foreground leading-relaxed list-disc">Dealer conduct</li>
                  <li className="text-base text-muted-foreground leading-relaxed list-disc">
