      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="space-y-10">
          ...
          <section id="responsibilities" className="scroll-mt-28">
            ...
            <div className="rounded-xl border border-border/40 bg-sidebar p-5">
              <p className="text-sm text-foreground leading-relaxed mb-3">The Dealer is solely responsible for:</p>
              <div className="space-y-2 mb-4">
                <p className="text-sm text-muted-foreground flex items-start gap-2">
                  <span className="text-muted-foreground/50 mt-1">•</span>
          ...
          <section id="prohibited" className="scroll-mt-28">
            ...
            <div className="rounded-xl border border-border/40 bg-sidebar p-5">
              <p className="text-sm text-foreground leading-relaxed mb-4">The Dealer must not:</p>
