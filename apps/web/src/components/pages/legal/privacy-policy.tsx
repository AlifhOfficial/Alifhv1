          ...
          <section>
            ...
            <div className="rounded-xl border border-border/40 bg-sidebar p-5">
              ...
              <div className="py-3 border-b border-border/20">
                <p className="text-sm font-semibold text-foreground mb-2">Information You Provide</p>
              ...
              <div className="py-3 border-b border-border/20">
                <p className="text-sm font-semibold text-foreground mb-2">Collected Automatically</p>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                  <p className="text-sm text-muted-foreground flex items-start gap-2">
                    <span className="text-muted-foreground/50 mt-1">•</span>
                    IP address
