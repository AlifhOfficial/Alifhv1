...
export function PricingHeroSection() {
  return (
    <section className="pt-28 pb-16 px-4 compact:px-6 large:px-8 border-b border-border/20">
      <div className="max-w-[1600px] mx-auto">
        ...
        <div className="max-w-3xl mx-auto text-center mb-16 space-y-5">
          ...
          <h1 className="text-title1 compact:text-display large:text-display1 font-semibold tracking-tight">
            Simple. Transparent.
            <br />
            <span className="text-muted-foreground">No games.</span>
          </h1>
          <p className="text-callout compact:text-headline text-muted-foreground leading-relaxed max-w-xl mx-auto">
            Two options. Same platform. Same core features. Different levels of attention and presence.
          </p>
        </div>

        <div className="flex items-center justify-center gap-12 compact:gap-20">
