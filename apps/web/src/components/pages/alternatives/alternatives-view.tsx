      ...
      <article className="pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-2xl mx-auto">
            ...
            <div className="rounded-xl border border-border/40 bg-sidebar p-5">
              <div className="space-y-4">
                <div className="flex gap-3">
                  <span className="flex-shrink-0 text-sm font-semibold text-primary">01</span>
                  <div>
                    <p className="text-sm font-semibold text-foreground mb-1">No listing fees for private sellers</p>
                    <p className="text-sm text-muted-foreground leading-relaxed">If you're selling your own car, you shouldn't pay to list it. Period.</p>
                  </div>
                </div>
                
                <div className="flex gap-3 pt-3 border-t border-border/20">
                  <span className="flex-shrink-0 text-sm font-semibold text-primary">02</span>
                  <div>
                    <p className="text-sm font-semibold text-foreground mb-1">Quality ranks, not payment</p>
                    <p className="text-sm text-muted-foreground leading-relaxed">Good photos and honest descriptions should rank higher than ads that paid more.</p>
                  </div>
                </div>
                ...
                <div className="flex gap-3 pt-3 border-t border-border/20">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-foreground mb-1">No banner ads or sponsored listings</p>
                    <p className="text-sm text-muted-foreground leading-relaxed">When you browse cars, you should see cars—not ads, not promotions, not upsells.</p>
                  </div>
                </div>
                
                <div className="flex gap-3 pt-3 border-t border-border/20">
                  <span className="flex-shrink-0 text-sm font-semibold text-primary">05</span>
                  <div>
                    <p className="text-sm font-semibold text-foreground mb-1">Test drive booking online</p>
                    <p className="text-sm text-muted-foreground leading-relaxed">Buyers should be able to request test drives without endless phone tag.</p>
                  </div>
                </div>
                
                <div className="flex gap-3 pt-3 border-t border-border/20">
                  <span className="flex-shrink-0 text-sm font-semibold text-primary">06</span>
                  <div>
                    <p className="text-sm font-semibold text-foreground mb-1">Expired listings removed automatically</p>
                    <p className="text-sm text-muted-foreground leading-relaxed">Sold cars should disappear. Buyers shouldn't waste time on outdated listings.</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <section className="mb-10">
            ...
            <div className="rounded-xl border border-border/40 bg-sidebar p-5">
              ...
              <div className="space-y-3">
                <div className="flex gap-3">
                  <span className="flex-shrink-0 text-sm font-semibold text-primary">01</span>
                  <p className="text-sm text-muted-foreground leading-relaxed pt-0.5">Browse existing listings to see how the platform works</p>
                </div>
                <div className="flex gap-3 pt-2 border-t border-border/20">
                  <span className="flex-shrink-0 text-sm font-semibold text-primary">02</span>
                  <p className="text-sm text-muted-foreground leading-relaxed pt-0.5">Create a free account (takes 30 seconds)</p>
                </div>
                <div className="flex gap-3 pt-2 border-t border-border/20">
                  <span className="flex-shrink-0 text-sm font-semibold text-primary">03</span>
                ...
                <div className="flex gap-3 pt-2 border-t border-border/20">
                  <span className="flex-shrink-0 text-sm font-semibold text-primary">04</span>
                  <p className="text-sm text-muted-foreground leading-relaxed pt-0.5">Buyers book test drives online, you approve and meet</p>
                </div>
              </div>
            </div>
          </section>
          ...
          <section className="mt-12 rounded-xl border border-border/40 bg-sidebar p-8 text-center">
            <p className="text-sm font-semibold text-foreground mb-2">Try It Free</p>
    ...
    <div className="rounded-xl border border-border/40 bg-sidebar p-5">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="flex items-start gap-2">
          ...
          <div>
            <p className="text-xs text-muted-foreground/60 mb-1">Typical platforms</p>
