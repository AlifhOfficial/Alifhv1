...
interface SignInModalProps {
  ...
  // Apple Sign In disabled for v1 - backend ready, UI hidden
          ...
          <div className="flex-1 overflow-y-auto p-6 pt-5">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <button
                    ...
                    disabled={isLoading || isPasskeyLoading}
                    className="absolute right-3 top-1/2 -translate-y-1/2 p-1 rounded-md text-muted-foreground/40 hover:text-primary transition-colors disabled:opacity-50"
            ...
            {(onGoogleSignIn || onSwitchToMagicLink) && (
              <div className="flex gap-3">
                ...
                {/* Apple Sign In disabled for v1 - backend ready */}
