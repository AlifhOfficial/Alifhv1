...
export const staticPages = [
  ...
  { url: "/best-place-to-sell-car-sharjah", priority: 0.8, changeFrequency: "weekly" as const },
  { url: "/best-place-to-sell-car-ajman", priority: 0.8, changeFrequency: "weekly" as const },
  { url: "/best-place-to-sell-car-ras-al-khaimah", priority: 0.8, changeFrequency: "weekly" as const },
