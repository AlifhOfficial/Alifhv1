  ...
  },
  {
    ...
    items: [
      // About Alifh
      {
        ...
        answer: "Alifh is a car marketplace platform based in Dubai, UAE. It offers free listings for individual sellers, quality-based ranking (no paid boosts), VIN included on every listing for transparency, and built-in test drive booking for dealers.",
      ...
      },
      {
        ...
        answer: "Alifh is based in Dubai, United Arab Emirates. The company operates with a local team focused on serving the UAE automotive market.",
        keywords: ["location", "Dubai", "UAE", "based", "where"],
      },
      {
        id: "general-uae-only",
        question: "Is Alifh available outside the UAE?",
        answer: "Currently, Alifh is only available in the United Arab Emirates. The platform is focused on the UAE market, with all listings, features, and support designed for UAE users.",
        keywords: ["UAE", "country", "region", "available"],
      },
      // How It's Different
      {
        id: "general-different",
        question: "How is Alifh different from other car selling websites?",
        answer: "Alifh differs from other car platforms in key ways: free listings for individuals (no fees ever), no paid boosts (quality-based ranking only), VIN on every listing for transparency, and built-in test drive booking. Visibility is earned through quality, not payment.",
      ...
      },
      {
        ...
        answer: "Alifh doesn't have ads to provide a clean, fast user experience. The business model relies on partner subscriptions, not advertising revenue. This means no banner ads, no pop-ups, and no promoted content cluttering your search results.",
      ...
      // Trust & Safety
      {
        ...
        answer: "Alifh reduces scams by including VIN on every listing, seller rating systems, response time tracking, and review verification. These measures help improve transparency and accountability.",
        keywords: ["scam", "fraud", "safe", "trust", "verify"],
      },
      {
        id: "general-verified",
        question: "Are car listings on Alifh verified?",
        answer: "All Alifh listings include a VIN (Vehicle Identification Number), allowing buyers to independently verify vehicle history and specifications. Additional verification features for sellers are currently in development.",
      ...
      // Business Model
      {
        ...
        answer: "Alifh makes money through monthly subscription fees paid by dealer partners. Individual sellers list for free. The platform charges zero commission on sales and generates no revenue from advertising.",
