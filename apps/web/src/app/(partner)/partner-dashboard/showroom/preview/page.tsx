    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="text-center max-w-md mx-auto px-4">
          ...
          <h1 className="text-title3 font-medium text-foreground mb-2">
          ...
          <Link 
            ...
            className="inline-flex items-center gap-1.5 px-4 py-2 text-subhead font-medium bg-primary text-primary-foreground rounded-lg hover:bg-primary/90 transition-colors"
          >
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="sticky top-0 z-50 bg-amber-500 text-amber-950">
        <div className="max-w-[1600px] mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <Link 
            href="/partner-dashboard/showroom"
            className="inline-flex items-center gap-1.5 px-3 py-1.5 text-subhead font-medium bg-amber-950 text-amber-50 rounded-md hover:bg-amber-900 transition-colors"
          >
            <ArrowLeft className="w-4 h-4" />
            Back to Editor
          </Link>
