...
export const metadata: Metadata = {
  ...
  description: 'List your car free in UAE. No listing fees, no boosts, no ads. Book test drives online. Private sellers pay nothing. Ever. The free alternative.',
  ...
  openGraph: {
    title: 'Sell Your Car in Dubai — Free Forever | Revvup',
    description: 'List your car free in UAE. No fees, no boosts, no ads.',
    type: 'website',
