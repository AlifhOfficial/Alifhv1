/**
 * Car Listing Static Data Constants
 * 
 * Centralized source of truth for all car listing enums, makes, models, etc.
 * Used across schema, forms, and APIs.
 * 
 * @module packages/database/src/schema/listing-constants
 */
...
// ============================================================================
// REGIONAL SPECS - Added Chinese & Korean for UAE market
// ============================================================================
...
/**
 * Special Notes are owner's personal remarks about the car.
 * Examples:
 * - "Modified exhaust system for better sound"
 * - "Always kept in air-conditioned garage"
 * - "New tires installed last month"
 * - "Minor scratch on rear bumper"
 * 
 * This is separate from:
 * - description: General car description
 * - tags: Predefined selectable tags (max 3)
 * - extras: Vehicle features/options
 */
...
/**
 * Generate a URL-friendly slug from make, model, year
 * Example: "toyota-camry-2024-abc123"
 */
